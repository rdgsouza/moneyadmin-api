...
public class Lancamento {
	...
	// A anotação @JsonIgnore é para o meto isReceita não ser retornado no json como resposta pois
	// vamos utiliza-lo apenas para verificar se e uma receita ou nao para o uso no template 
	// do e-mail usando o timelift.
	@JsonIgnore 
