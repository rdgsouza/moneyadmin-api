...
import com.rodrigo.moneyadmin.api.service.PessoaService;
...
public class PessoaResource {
	...
	public ResponseEntity<Pessoa> buscarPeloCodigo(@PathVariable Long codigo) {
     ...
     //Tem pessoas presente na pesquisa feita se sim entao ok retorna as pessoas se não status notFound
	}
